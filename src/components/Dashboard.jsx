...
import { BsHeart, BsPersonCircle, BsBoxSeam, BsEnvelope, BsCart2, BsHeartFill } from 'react-icons/bs';
...
export const Dashboard = () => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      case 'profile':
        return (
          <div className="space-y-8">
            <h2 className="text-2xl font-bold text-[#326287] mb-6">Welcome back, {user.name}!</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                ...
                <form onSubmit={handleCouponSubmit} className="space-y-3">
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#e8b09e] focus:border-transparent"
                  />
                  <button
                    type="submit"
                    className="w-full px-6 py-2 bg-[#e8b09e] hover:bg-[#D59C8C] text-white rounded-lg transition-colors font-semibold"
                  >
                    Redeem
                  </button>
                </form>
              ...
              {/* Special Offers */}
              <div className="bg-white rounded-xl shadow-md p-6">
                <h3 className="text-xl font-semibold text-[#326287] mb-4">Special Offers for You</h3>
                ...
                <div className="relative bg-gradient-to-r from-[#e8b09e] to-[#D59C8C] rounded-lg p-4 text-white">
                  <div className="absolute left-0 top-1/2 transform -translate-y-1/2 w-full">
                    <div className="border-t-2 border-dotted border-white/30"></div>
                  </div>
                  ...
                  <div className="flex flex-col gap-3 relative z-10">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs opacity-90">Valid until 31.09.2025</p>
                      </div>
                    </div>
                    <button
                      onClick={claimOffer}
                      className="bg-white text-[#e8b09e] px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm"
                    >
                      Claim
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-xl font-semibold text-[#326287] mb-4">Loyalty Points</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-[#326287] font-medium">Current Points</span>
                  <span className="text-[#e8b09e] font-bold text-lg">{points} points</span>
                </div>
                ...
                <p className="text-[#326287] text-sm">
                  Collect <span className="font-semibold text-[#e8b09e]">{pointsNeeded - points} more points</span> to earn a 
                  <span className="font-semibold"> €10 voucher</span> for your next order!
                </p>
                
                <div className="bg-[#e8b09e]/10 rounded-lg p-4">
                  <h4 className="font-semibold text-[#326287] mb-2">How to earn points:</h4>
      ...
      case 'orders':
        return (
          <div>
            <h2 className="text-2xl font-bold text-[#326287] mb-6">Your Orders</h2>
            <div className="bg-white rounded-xl shadow-md p-6">
      ...
      case 'favorites':
        return (
          <div>
            <h2 className="text-2xl font-bold text-[#326287] mb-6">Your Favorites</h2>
            {favorites.length === 0 ? (
              <div className="bg-white rounded-xl shadow-md p-6">
                <p className="text-[#326287]/70">No favorites yet. Add some products to your favorites!</p>
              </div>
            ) : (
                  ...
                  <div key={product.id} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div className="p-4">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-[#e8b09e] hover:bg-[#D59C8C] transition-colors rounded-xl px-4 py-2 text-white font-semibold shadow-md"
                      >
                        <BsCart2 />
                        Add to Cart
                      </button>
      ...
      case 'newsletter':
        return (
          <div>
            <h2 className="text-2xl font-bold text-[#326287] mb-6">Newsletter Settings</h2>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-xl font-semibold text-[#326287] mb-4">Subscription Preferences</h3>
              <div className="space-y-4">
                ...
                <label className="flex items-center">
                  <input type="checkbox" className="mr-3" defaultChecked />
                  <span className="text-[#326287]">New product announcements</span>
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="mr-3" />
                  <span className="text-[#326287]">Beauty tips and tutorials</span>
                </label>
              </div>
            </div>
          </div>
      ...
      case 'settings':
        return (
          <div>
            <h2 className="text-2xl font-bold text-[#326287] mb-6">Account Settings</h2>
            <div className="bg-white rounded-xl shadow-md p-6">
              <h3 className="text-xl font-semibold text-[#326287] mb-4">Privacy & Security</h3>
              <div className="space-y-4">
                <button className="w-full text-left p-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                  Change Password
                </button>
                <button className="w-full text-left p-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition">
                  Privacy Settings
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-30 flex gap-6 px-6 md:px-12 pb-10">
      <aside className="hidden md:flex flex-col sticky top-24 h-[calc(100vh-6rem)] w-64 bg-white rounded-lg shadow-md p-6" style={{
          background: "linear-gradient(50deg, #326287 25%, #D59C8C 85%, #E8B09E 100%)",
          transition: "background 0.5s ease-in-out"
        }}>
        <h3 className="text-2xl font-bold text-center mb-6 text-white">Dashboard</h3>
