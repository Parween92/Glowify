        ...
        <div className="bg-white rounded-xl shadow-md p-8 text-center">
          ...
          <div className="border rounded-lg p-6 mb-8 text-left">
            ...
            <div className="space-y-2 mb-4">
              ...
              <p><span className="font-medium">Items:</span> {orderData.items.reduce((total, item) => total + (item.quantity || 1), 0)}</p>
            </div>

            <div className="border-t pt-4">
              <h4 className="font-medium text-[#326287] mb-2">Items Ordered:</h4>
          ...
          <div className="space-y-4">
            <Link
              to="/products"
              className="w-full bg-[#D59C8C] text-white font-semibold py-3 px-6 rounded-lg hover:bg-[#B3746E] transition-colors inline-block"
            >
              Continue Shopping
            </Link>
            <Link
              to="/"
              className="w-full border border-[#326287] text-[#326287] font-semibold py-3 px-6 rounded-lg hover:bg-[#326287] hover:text-white transition-colors inline-block"
            >
              Back to Home
            </Link>
          </div>
